...
namespace Snake
{
    ...
    static class Settings
    {
        ...
        public static readonly string topScoresFile = Path.Combine(Assembly.GetEntryAssembly().Location, "../.top3games");
    }
    ...
    static class Tools
    {
        ...
        private static void SerializeNow(List<ScoreTime> games)
        {
            ...
            File.WriteAllText(Settings.topScoresFile, json);
        }

        private static List<ScoreTime> DeSerializeNow()
        {
            string fileText = File.ReadAllText(Settings.topScoresFile);
            return JsonSerializer.Deserialize<List<ScoreTime>>(fileText);
        }
